  ...
  <section id="posts">
    <div class="container">
      <div class="grid-row justify-center padding-bottom-basic">
        <h1 class="grid-item item-s-12 font-uppercase font-size-large font-heavy padding-top-small padding-bottom-small text-align-center">Incubator Projects</h1>
      </div>
      <div class="grid-row justify-center padding-bottom-basic" id="posts-holder">
<?php
  while (have_posts()) {
    the_post();
...
?>
        <article <?php post_class('grid-item no-gutter item-s-12 padding-bottom-tiny grid-row'); ?> id="post-<?php the_ID(); ?>">
          ...
          <div class="grid-item item-s-12 item-m-7 padding-bottom-small no-gutter grid-row align-content-between">
            ...
            <div class="grid-item item-s-6 font-size-small font-uppercase font-heavy"><span><span><?php echo $type ? $type : ''; ?></span></span></div>
          </div>
        </article>
<?php
  }
