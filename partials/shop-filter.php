...
<div id="shop-menu" class="background-pale border-bottom">
  <div class="container">
    <ul id="shop-menu-list" class="grid-row padding-top-tiny">
      <li class="padding-bottom-tiny grid-item item-s-12 item-l-auto offset-l-6 shop-sub-menu-trigger">
        <span>Mediums</span>
        <div class="shop-sub-menu padding-top-small padding-bottom-tiny grid-row">
          <ul class="shop-sub-menu-list grid-item item-s-12 item-l-6 offset-m-6 no-gutter grid-row">
          <?php
            foreach ($mediums as $term) {
              $params = array('filter' => 'medium', 'by' => $term->slug);
          ?>
            <li class="shop-sub-menu-item grid-item item-s-12 item-l-3 margin-bottom-tiny"><a href="<?php echo add_query_arg($params); ?>"><?php echo $term->name; ?></a></li>
          <?php } ?>
          </ul>
        </div>
      </li>
      <li class="padding-bottom-tiny grid-item item-s-12 item-l-auto shop-sub-menu-trigger">
        <span>Artists</span>
        <div class="shop-sub-menu padding-top-small padding-bottom-tiny grid-row">
          <ul class="shop-sub-menu-list grid-item item-s-12 item-l-6 offset-m-6 no-gutter grid-row">
          <?php
      ...
      <li class="padding-bottom-tiny grid-item item-s-12 item-l-auto shop-sub-menu-trigger">
        ...
        <div class="shop-sub-menu padding-top-small padding-bottom-tiny grid-row">
          <ul class="shop-sub-menu-list grid-item item-s-12 item-l-6 offset-m-6 no-gutter grid-row">
            <li class="shop-sub-menu-item grid-item item-s-12 item-l-3 margin-bottom-tiny">
