<div id="popup-notice-holder" class="grid-row justify-center align-items-center hide">
  <div id="popup-notice-overlay" class="js-close-popup"></div>
  <div id="popup-notice">
    <div class="grid-row padding-top-small padding-bottom-small justify-center">
      ...
      <div class="grid-item item-s-12 text-align-center font-size-small margin-top-tiny">
        <span><a href="#" class="link-underline js-close-popup">Continue to website</a></span>
      </div>
    </div>
  </div>
</div>
