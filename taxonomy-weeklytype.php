...
?>
        <h1 class="grid-item item-s-12 font-uppercase font-size-large font-heavy padding-top-small padding-bottom-small text-align-center font-color-blush"><?php echo $weeklytype->name; ?></h1>
<?php
  while (have_posts()) {
    the_post();
